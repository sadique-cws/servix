    ...
    <div class="container px-5" style="margin-top: 200px">
        <div class="row justify-content-center px-auto">
            <div class="col-lg-6 col-md-9 col-12">
                ...
                <h4 class="train_ing pt-2 pl-5 text-[28px] text-gray-800">You have any question, comments or feedback please don't hesitate to get
                    in touch with us.</h4>
            </div>
        </div>
        <div class="container" style="margin-top: 150px;">
            <div class="row justify-content-center">
                <div class="col-10">
                    <div class="row justify-content-center">
                        <div class="col-md-6 col-12 mb-3 hover:scale-110 overflow-hidden hover:-translate-x-[10px] hover:-translate-y-[5px] transition-all duration-500 ease-in-out">
                    ...
                    <div class="group card card_contact2 p-3 mt-4 hover:scale-110 overflow-hidden hover:-translate-y-[5px] transition-all duration-500 ease-in-out">
                        <div class="text-center self-center self-center ites-center justify-center">
                            <img src="Assets/map.svg" class="img_whats2 group-hover:scale-150 transition-all ease-in-out duration-500" alt="logo">
            ...
            <div class="bg-gray-800 lg:px-32 px-5 py-12 rounded-lg">
                ...
                <form action="" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <label for="first_name" class="group-hover:text-[18px] peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">First name</label>
                        @error('first_name')
                            <div class="text-slate-100 bg-red-500/30 p-2 rounded-b-lg transition-all duration-300 ease-in tracking-wide">{{$message}}</div>
                        @enderror
                    </div>
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="last_name" id="last_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-500 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        <label for="last_name" class="group-hover:text-[18px] peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Last name</label>
                        @error('last_name')
                            <div class="text-slate-100 bg-red-500/30 p-2 rounded-b-lg transition-all duration-300 ease-in tracking-wide">{{$message}}</div>
                        @enderror                    
                    </div>
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <label for="company" class="group-hover:text-[18px] peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Company (Ex. Google) <span class="text-[12px] text-center item-center  text-white py-0 px-2 rounded-lg bg-yellow-600" ><small>optional</small> </span> </label>
                        @error('company')
                            <div class="text-slate-100 bg-red-500/30 p-2 rounded-b-lg transition-all duration-300 ease-in tracking-wide">{{$message}}</div>
                        @enderror                     
                    </div>
                    ...
                    <div class="relative z-0 w-full mb-6">
                        <input type="email" name="email" id="email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-500 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        <label for="email" class="group-hover:text-[18px] peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Email address</label>
                        @error('email')
                            <div class="text-slate-100 bg-red-500/30 p-2 rounded-b-lg transition-all duration-300 ease-in tracking-wide">{{$message}}</div>
                        @enderror
                    </div>
                    <div class="relative z-0 w-full mb-6">
                        <input type="text" name="subject" id="subject" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-500 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="relative z-0 w-full mb-6">
                        <input type="text" name="message" id="message" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-500 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        <label for="message" class="group-hover:text-[18px] peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Message/Inquiry</label>
                        @error('message')
                            <div class="text-slate-100 bg-red-500/30 p-2 rounded-b-lg transition-all duration-300 ease-in tracking-wide">{{$message}}</div>
                        @enderror
                    </div>
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="inspired_from" name="inspired_from" id="inspired_from" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-500 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        <label for="inspired_from" class="group-hover:text-[18px] peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">How did you hear about us?</label>
                        @error('inspired_from')
                            <div class="text-slate-100 bg-red-500/30 p-2 rounded-b-lg transition-all duration-300 ease-in tracking-wide">{{$message}}</div>
                        @enderror
                    </div>
                    <button type="submit" class="py-2.5 my-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5  text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 self-end ease-in-out duration-300 hover:tracking-widest">Submit</button>
